...
{#if menu}
  ...
  <div
    ...
    use:glass={{ blur: 13, saturate: 1.6, brightness: 0.9, bezel: 12, strength: 18, lens: 0.06 }}
...
{#if appearance}
  ...
  <div
    ...
    use:glass={{ blur: 14, saturate: 1.6, brightness: 0.92, bezel: 22, strength: 28, lens: 0.06 }}
  ...
  <div class="select">
    ...
    {#if openSelect === key}
      ...
      <div
        class="select-menu"
        role="listbox"
        use:glass={{ blur: 12, saturate: 1.5, brightness: 0.8, bezel: 10, strength: 14, lens: 0.05 }}
...
<style>
  ...
  .imm-menu {
    ...
    background:
      ...
      rgba(18, 10, 16, 0.5);
    backdrop-filter: blur(13px) saturate(1.6) brightness(0.9);
    box-shadow:
  ...
  .appearance {
    ...
    background:
      ...
      rgba(16, 9, 14, 0.46);
    backdrop-filter: blur(14px) saturate(1.6) brightness(0.92);
    box-shadow:
  ...
  .select-menu {
    ...
    background:
      ...
      rgba(10, 6, 9, 0.6);
    backdrop-filter: blur(12px) saturate(1.5) brightness(0.8);
    box-shadow:
